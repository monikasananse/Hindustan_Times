...
function LeftSideCom() {
  ...
  useEffect(()=>{
    axios({
      url:"https://newsapi.org/v2/everything?q=latest&apiKey=81cd23c204f349be81345237249f7737",
      method:"GET"
    })
    .then((res)=>{
  ...
  return (
    ...
    {data?.map((news)=>(
      <div style={{height:"30%",width:"100%",marginLeft:"1%",marginRight:"1%",boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px",marginTop:"2rem"}} key={news.id}>
